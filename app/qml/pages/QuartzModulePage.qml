...
Item {
    ...
    property var errCalEntity: VeinEntity.getEntity("SEC1Module1")
    property var moduleIntrospection: ModuleIntrospection.sec1m1Introspection
    ...
    readonly property real pointSize: Math.max(height * 0.03, 10)
        ...
        Row {
            ...
            SwipeView {
                ...
                ParamViewQuartz {
                    ...
                    validatorFrequency: moduleIntrospection.ComponentInfo.PAR_MRate.Validation
