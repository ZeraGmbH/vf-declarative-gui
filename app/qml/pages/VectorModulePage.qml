...
Item {
    ...
    PhasorDiagramEx {
        ...
        minVoltage: nominalSelection === VectorSettingsLengths.MAXIMUM ? nominalVoltage * 0.001 : nominalVoltage * 0.05
        nominalCurrent: maxRejectionI
        minCurrent: nominalSelection === VectorSettingsLengths.MAXIMUM ? nominalCurrent * 0.001 : nominalCurrent * 0.05
    }
