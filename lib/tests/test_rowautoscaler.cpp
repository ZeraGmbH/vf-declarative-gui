...
{
    RowAutoScaler scaler;
    RowAutoScaler::TSingleScaleResult res = scaler.scaleSingleVal(999);
    QCOMPARE(res.unitPrefix, "");
    QCOMPARE(res.scaleFactor, 1.0);
}
...
{
    RowAutoScaler scaler;
    RowAutoScaler::TSingleScaleResult res = scaler.scaleSingleVal(999999);
    QCOMPARE(res.unitPrefix, "k");
    QCOMPARE(res.scaleFactor, 1e-3);
}
...
{
    RowAutoScaler scaler;
    RowAutoScaler::TSingleScaleResult res = scaler.scaleSingleVal(1000001);
    QCOMPARE(res.unitPrefix, "M");
...
{
    RowAutoScaler scaler;
    RowAutoScaler::TSingleScaleResult res = scaler.scaleSingleVal(1e9+1);
